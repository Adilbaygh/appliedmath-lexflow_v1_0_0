...
- бешта репродуктив scale test’да (500 истеъмолчи ва 1022 қиррагача)
  $\lambda^*=0.60$, sparse HiGHS ечими ёпиқ формула билан floating-point
  аниқлигида мос;
...
[`v0.4.0` release](https://github.com/Adilbaygh/appliedmath-lexflow_v1_0_0/releases/tag/v0.4.0)
