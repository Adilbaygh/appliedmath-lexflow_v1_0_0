...
ихчам натижа жадваллари ва репродуктивлик метамаълумотлари сақланади. `0.5.0`
версияси GitHub’даги
[`v0.5.0` release](https://github.com/Adilbaygh/appliedmath-lexflow_v1_0_0/releases/tag/v0.5.0)
